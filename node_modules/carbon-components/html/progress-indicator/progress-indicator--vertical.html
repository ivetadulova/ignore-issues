...
<ul data-progress data-progress-current class="bx--progress bx--progress--vertical">
    ...
    <li class="bx--progress-step bx--progress-step--current "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltipkgtjeul1cf9">
            Second Step
      </p>
      <div id="label-tooltipkgtjeul1cf9" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
    ...
    <li class="bx--progress-step bx--progress-step--incomplete "  >
      ...
      <p tabindex="0" class="bx--progress-label" aria-describedby="label-tooltip5asukzo6qmk">
            Third Step
      </p>
      <div id="label-tooltip5asukzo6qmk" role="tooltip" data-floating-menu-direction="bottom" class="bx--tooltip" data-avoid-focus-on-open>
        <span class="bx--tooltip__caret"></span>
