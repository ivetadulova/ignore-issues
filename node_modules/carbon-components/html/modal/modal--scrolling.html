...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tmlszucnai">Show
  modal</button>

<div data-modal id="modal-tmlszucnai" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tmlszucnai-label" aria-describedby="modal-tmlszucnai-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tmlszucnai-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tmlszucnai-heading">Modal heading</p>
