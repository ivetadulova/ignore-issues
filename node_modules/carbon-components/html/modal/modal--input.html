...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-x092lfsvh89">Show
  modal</button>

<div data-modal id="modal-x092lfsvh89" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-x092lfsvh89-label" aria-describedby="modal-x092lfsvh89-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-x092lfsvh89-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-x092lfsvh89-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-x092lfsvh89" class="bx--label">Text Input label</label>
        <input id="text-input-x092lfsvh89" type="text" class="bx--text-input" placeholder="Optional placeholder text"
