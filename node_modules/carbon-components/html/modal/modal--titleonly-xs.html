...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-re0c7n6pabl">Show
  modal</button>

<div data-modal id="modal-re0c7n6pabl" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-re0c7n6pabl-label" aria-describedby="modal-re0c7n6pabl-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-re0c7n6pabl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-re0c7n6pabl-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
