...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-p13iw1o5mt7">Show
  modal</button>

<div data-modal id="modal-p13iw1o5mt7" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-p13iw1o5mt7-label" aria-describedby="modal-p13iw1o5mt7-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-p13iw1o5mt7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-p13iw1o5mt7-heading">Modal heading</p>
