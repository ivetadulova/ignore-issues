...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-b3qm2pfukj">Show
  modal</button>

<div data-modal id="modal-b3qm2pfukj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-b3qm2pfukj-label" aria-describedby="modal-b3qm2pfukj-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-b3qm2pfukj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-b3qm2pfukj-heading">Modal heading</p>
