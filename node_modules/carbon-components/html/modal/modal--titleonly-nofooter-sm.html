...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-4ytpwco7evh">Show
  modal</button>

<div data-modal id="modal-4ytpwco7evh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-4ytpwco7evh-label" aria-describedby="modal-4ytpwco7evh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-4ytpwco7evh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-4ytpwco7evh-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
