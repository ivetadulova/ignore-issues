...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-3ulaqg0mox3">Show
  modal</button>

<div data-modal id="modal-3ulaqg0mox3" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-3ulaqg0mox3-label" aria-describedby="modal-3ulaqg0mox3-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-3ulaqg0mox3-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-3ulaqg0mox3-heading">Modal heading</p>
