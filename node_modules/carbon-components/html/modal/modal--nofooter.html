...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-krl05xojkgo">Show
  modal</button>

<div data-modal id="modal-krl05xojkgo" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-krl05xojkgo-label" aria-describedby="modal-krl05xojkgo-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-krl05xojkgo-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-krl05xojkgo-heading">Modal heading</p>
