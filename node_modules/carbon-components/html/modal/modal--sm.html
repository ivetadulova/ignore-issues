...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rlbla3t70j">Show
  modal</button>

<div data-modal id="modal-rlbla3t70j" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rlbla3t70j-label" aria-describedby="modal-rlbla3t70j-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rlbla3t70j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rlbla3t70j-heading">Modal heading</p>
