...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-c6yfqqz7nc">Show
  modal</button>

<div data-modal id="modal-c6yfqqz7nc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-c6yfqqz7nc-label" aria-describedby="modal-c6yfqqz7nc-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-c6yfqqz7nc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-c6yfqqz7nc-heading">Modal heading</p>
