...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cz0xzgynq8">Show
  modal</button>

<div data-modal id="modal-cz0xzgynq8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cz0xzgynq8-label" aria-describedby="modal-cz0xzgynq8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cz0xzgynq8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cz0xzgynq8-heading">Modal heading</p>
